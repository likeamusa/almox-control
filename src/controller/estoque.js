    ...
    async getStock(req, res) {
        ...
        try {
            ...
            const saldo = await sequelize.query(`
                SELECT c.id_centro AS centro_id, c.descricao AS nome_centro, m.id_material, ma.descricao,SUM(CASE WHEN tm.mov = 'E' THEN m.qtde ELSE -m.qtde END) AS saldo
                ...
                GROUP BY c.id_centro, c.descricao, m.id_material, ma.descricao;
            `)
